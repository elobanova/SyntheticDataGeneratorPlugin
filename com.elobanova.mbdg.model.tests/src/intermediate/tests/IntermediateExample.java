...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>intermediate</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class IntermediateExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.intermediate"));
				GeneratorAttributeElement root = IntermediateFactory.eINSTANCE.createGeneratorAttributeElement();
